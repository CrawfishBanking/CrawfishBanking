...
//        addSubview(_titleLbl)
        //实例化PageControl
        _pgCtrl = UIPageControl(frame: CGRect(x:0, y: _size.height - 25, width: Screen_Width, height: 30))
        _pgCtrl.isEnabled = false
        _pgCtrl.pageIndicatorTintColor = UIColor.init(hexColor: "999999")
        _pgCtrl.currentPageIndicatorTintColor = UIColor.init(hexColor: "3333333")

        addSubview(_pgCtrl)
        
//        _rightView.contentMode = .scaleToFill
//        _leftView.contentMode = .scaleToFill
//        _centerView.contentMode = .scaleToFill
